...
const MeetTheTeamDarkPage: React.FC = () => {
  ...
  return (
    <>
      {/* Overlay dark gradient, but let the grid show through from body */}
      ...
      >
        ...
        <div className="flex space-x-4 mb-8 relative z-10">
          ...
          >
            ...
            />
            <span
              className="text-[24px] leading-[163%] text-black z-10 transition-all duration-1000"
              style={{ fontFamily: "'Press Start 2P', monospace", fontWeight: 400, letterSpacing: 0 }}
            >
              BOARD
            </span>
          </button>
        ...
        {view === 'board' ? (
          ...
          <div className="flex flex-col items-center space-y-8 relative z-10">
            <h2 className="text-3xl font-bold text-gray-200">Departments View</h2>
            <p className="text-lg text-gray-300">This is a placeholder for the Departments content.</p>
