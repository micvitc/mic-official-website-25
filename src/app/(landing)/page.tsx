...
type Props = {};
//base characteristics of each event card
const boxStyle = {
  width: "340px",
  height: "308px",
  borderRadius: "0px",
    ...
    <div className="w-full min-h-screen flex flex-col justify-start items-center mt-5 bg-[linear-gradient(to_bottom,#000810_0%,#003755_34%,#113373_71%,#192C55_100%)]">
      ...
      <div className="flex flex-col gap-10 my-20">
        ...
        <div className="flex flex-row gap-10 justify-start">
          {/*card charcateristics such as fill color,text color and border dimensions*/} 
          <div
            className="text-2xl font-press-start"
            style={{ ...boxStyle, backgroundColor: "#FFDFE8", color: "#6d1c22",border:"12px solid #E8A2B5" }}>
            Event Name 
            <p style={{ fontWeight: "normal", fontSize: "16px", marginTop: "10px", fontFamily: "'IBM Plex Mono', monospace" }}>
